...
public class ClassObject extends ClassDeclarationObject {
    ...
    private ASTInformation typeDeclaration2;
    private IFile iFile;
    ...
    public void setAbstractTypeDeclaration(AbstractTypeDeclaration typeDeclaration) {
    	...
    	this.typeDeclaration2 = ASTInformationGenerator.generateASTInformation(typeDeclaration);
    }
    ...
    public ITypeRoot getITypeRoot() {
    	return typeDeclaration2.getITypeRoot();
    }
